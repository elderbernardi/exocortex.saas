# Karpathy Guidelines — Anti-Pattern Examples
...
> The "overcomplicated" examples aren't obviously wrong — they follow design patterns and best practices.
> The problem is **timing**: they add complexity before it's needed.

**Simple versions are:** easier to understand, faster to implement, easier to test, and can be refactored later when complexity is actually needed.
