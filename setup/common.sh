...
#
# Também preserva quais campos EXOCORTEX_* já vieram do processo pai, para que
# steps posteriores consigam distinguir "veio do shell" de "veio do fallback
# .env.local".

_EXOCORTEX_PARENT_HAS_DEFAULT_PROVIDER="${EXOCORTEX_DEFAULT_PROVIDER+1}"
_EXOCORTEX_PARENT_HAS_DEFAULT_MODEL="${EXOCORTEX_DEFAULT_MODEL+1}"
_EXOCORTEX_PARENT_HAS_DEFAULT_API_KEY="${EXOCORTEX_DEFAULT_API_KEY+1}"
_EXOCORTEX_PARENT_HAS_DEFAULT_BASE_URL="${EXOCORTEX_DEFAULT_BASE_URL+1}"
_EXOCORTEX_PARENT_HAS_AUX_PROVIDER="${EXOCORTEX_AUX_PROVIDER+1}"
_EXOCORTEX_PARENT_HAS_AUX_MODEL="${EXOCORTEX_AUX_MODEL+1}"
_EXOCORTEX_PARENT_HAS_AUX_API_KEY="${EXOCORTEX_AUX_API_KEY+1}"
_EXOCORTEX_PARENT_HAS_AUX_BASE_URL="${EXOCORTEX_AUX_BASE_URL+1}"
_EXOCORTEX_PARENT_DEFAULT_PROVIDER="${EXOCORTEX_DEFAULT_PROVIDER:-}"
_EXOCORTEX_PARENT_DEFAULT_MODEL="${EXOCORTEX_DEFAULT_MODEL:-}"
_EXOCORTEX_PARENT_DEFAULT_API_KEY="${EXOCORTEX_DEFAULT_API_KEY:-}"
_EXOCORTEX_PARENT_DEFAULT_BASE_URL="${EXOCORTEX_DEFAULT_BASE_URL:-}"
_EXOCORTEX_PARENT_AUX_PROVIDER="${EXOCORTEX_AUX_PROVIDER:-}"
_EXOCORTEX_PARENT_AUX_MODEL="${EXOCORTEX_AUX_MODEL:-}"
_EXOCORTEX_PARENT_AUX_API_KEY="${EXOCORTEX_AUX_API_KEY:-}"
_EXOCORTEX_PARENT_AUX_BASE_URL="${EXOCORTEX_AUX_BASE_URL:-}"
