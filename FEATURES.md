...
| Campo                      | Detalhe                                                                                                                                                                                                                                                                                                                                                       |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Funcionalidade**         | Conduz a entrevista estruturada de calibração do Exocórtex em 5 blocos (Identidade Profissional, Estilo de Comunicação, Domínios de Atuação, Preferências Operacionais, Integrações). Gera `SOUL.md`, microversos iniciais e `estilo.md`. Suporta interrupção parcial (salva estado), defaults para blocos pulados, e re-onboarding com merge não-destrutivo. |
