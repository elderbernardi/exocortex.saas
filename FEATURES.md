...
| **Instalação**             | `setup.sh` copia a skill; `compile_soul.py` injeta `compiled_rules` na seção `## Conduct Loop` de `SOUL_SEED.md`, propagada ao runtime via `compile_soul.py --soul "$HERMES_HOME/SOUL.md"` (cirúrgico, preserva onboarding; **não** via step-07 `cp` — destrutivo num install personalizado; ADR-CT-07).                                                                                                                                                                                            |
...
| **Instalação**             | `setup.sh` copia a skill; `compile_soul.py` injeta `compiled_rules` na seção `## Conduct Bounds` de `SOUL_SEED.md`, propagada ao runtime via `compile_soul.py --soul "$HERMES_HOME/SOUL.md"` (cirúrgico, preserva onboarding; **não** via step-07 `cp` — destrutivo num install personalizado; ADR-CT-07).                                                                                                                                                                                                                       |
