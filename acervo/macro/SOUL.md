...
- **Contexto de Negócio** — ramo, empresas do grupo e concorrentes a monitorar
...
Durante o onboarding, esta seção passa a existir em formato parseável para consumo pelas skills de pesquisa:
