...
- [2026-06-21] update | Sincronização documental pós-MV-PACK (issue #94 / MV-PACK-9). `shared/groups.md` reescrito com 7 microversos e 4 grupos (DOMAINS, PROJECTS, ROLES, CRIACAO). `acervo/README.md` atualizado com 14 diretórios e contrato canônico. `global/_meta/index.md` referencia microverso-package-spec e microversos.yaml. `mvinstall` alinhado ao contrato de estrutura.
