...
Este microverso nasce para cobrir uma lacuna do Acervo: faltava um domínio próprio para setup, operação e manutenção do Exocórtex.

## Estado observado no momento da criação
...
Este arquivo descreve estado operacional do Exocórtex. Não deve conter identidade pessoal, valores ou estilo do executivo.
