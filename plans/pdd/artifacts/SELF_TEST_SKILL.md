# Exocórtex Self-Test Skill

> **Arquivo semente:** Inserir este conteúdo no Prompt 001 para criar a skill de auto-diagnóstico.

---

```markdown
---
name: exocortex-self-test
...
### 3. Verificar Skills
- [ ] `exocortex-self-test` presente e ativa
- [ ] `exocortex-prompt-log` presente (quando fase >= P1)
