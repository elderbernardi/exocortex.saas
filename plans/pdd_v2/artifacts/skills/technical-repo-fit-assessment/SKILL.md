---
name: technical-repo-fit-assessment
description: Avaliar se um repositório existente é adequado para servir como base de um produto, engine ou serviço maior; validar claims contra código, runtime e contrato operacional.
version: 1.0.0
category: exocortex
metadata:
  hermes:
