---
name: exocortex-base-microverso-setup
...
metadata:
  hermes:
    ...
    category: exocortex
    related_skills: [acervo-manager, exocortex-new-microverso, hermes-agent]
---
...
- Use `acervo-manager` para regras gerais de leitura/escrita no Acervo v2.
- Use `exocortex-new-microverso` para criar o microverso em si.
