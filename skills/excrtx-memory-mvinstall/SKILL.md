...
description: >-
  Instala um microverso empacotado verificando dependências de skills, pacotes Python/Node,
  e MCPs declarados no microverso.yaml. Executa hooks de pós-instalação e registra no
  manifest global. Ativar quando executivo pede para instalar um microverso de terceiros
  ou quando setup.sh provisiona microversos base com manifesto.
version: 1.0.0
category: exocortex
metadata:
  hermes:
