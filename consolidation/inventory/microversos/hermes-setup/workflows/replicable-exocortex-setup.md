...
12. PENDENTE — modelar um gateway de aprovação do Exocórtex em conjunto com decisões futuras de harness Hermes:
   - definir enforcement real de Draft-First para efeitos externos, com vínculo entre aprovação e fingerprint do draft;
   - preservar autonomia de background jobs e cron até a fronteira de staging privado;
   - decidir como a implantação do Exocórtex deve ocorrer para operar bem sobre o Hermes, sem drift entre identidade, harness e runtime.
