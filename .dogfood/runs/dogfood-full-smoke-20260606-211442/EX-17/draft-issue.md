# DRAFT Issue — EX-17 — Intake Multicanal (`excrtx-memory-intake`)

## Contexto
Dogfood conversacional local detectou status PARTIAL para a feature EX-17.

## Resultado observado
Cenário registrado; execução conversacional real pendente.

## Resultado esperado
- A conversa aciona a capacidade descrita em FEATURES.md para EX-17.
...
## Evidência
- Run: `.dogfood/runs/dogfood-full-smoke-20260606-211442/EX-17`
