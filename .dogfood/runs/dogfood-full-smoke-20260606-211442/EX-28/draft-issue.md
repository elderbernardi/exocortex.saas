# DRAFT Issue — EX-28 — NotebookLM Router (`excrtx-integrate-nlmroute`)

## Contexto
Dogfood conversacional local detectou status PARTIAL para a feature EX-28.

## Resultado observado
Cenário registrado; execução conversacional real pendente.

## Resultado esperado
- A conversa aciona a capacidade descrita em FEATURES.md para EX-28.
...
## Evidência
- Run: `.dogfood/runs/dogfood-full-smoke-20260606-211442/EX-28`
