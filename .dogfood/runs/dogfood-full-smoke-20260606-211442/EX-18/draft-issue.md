# DRAFT Issue — EX-18 — Anti-Slop Textual (`excrtx-quality-antislop`)

## Contexto
Dogfood conversacional local detectou status PARTIAL para a feature EX-18.

## Resultado observado
Cenário registrado; execução conversacional real pendente.

## Resultado esperado
- A conversa aciona a capacidade descrita em FEATURES.md para EX-18.
...
## Evidência
- Run: `.dogfood/runs/dogfood-full-smoke-20260606-211442/EX-18`
