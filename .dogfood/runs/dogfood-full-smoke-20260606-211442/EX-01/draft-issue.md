# DRAFT Issue — EX-01 — Welcome & Onboarding (`excrtx-onboard-welcome`)

## Contexto
Dogfood conversacional local detectou status PARTIAL para a feature EX-01.

## Resultado observado
Cenário registrado; execução conversacional real pendente.

## Resultado esperado
- A conversa aciona a capacidade descrita em FEATURES.md para EX-01.
...
## Evidência
- Run: `.dogfood/runs/dogfood-full-smoke-20260606-211442/EX-01`
