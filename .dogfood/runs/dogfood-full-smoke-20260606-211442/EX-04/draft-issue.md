# DRAFT Issue — EX-04 — Repo Fit Assessment (`excrtx-assess-repofit`)

## Contexto
Dogfood conversacional local detectou status PARTIAL para a feature EX-04.

## Resultado observado
Cenário registrado; execução conversacional real pendente.

## Resultado esperado
- A conversa aciona a capacidade descrita em FEATURES.md para EX-04.
...
## Evidência
- Run: `.dogfood/runs/dogfood-full-smoke-20260606-211442/EX-04`
