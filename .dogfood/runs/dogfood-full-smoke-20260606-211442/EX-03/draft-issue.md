# DRAFT Issue — EX-03 — Self-Test / Auto-diagnóstico (`excrtx-assess-selftest`)

## Contexto
Dogfood conversacional local detectou status PARTIAL para a feature EX-03.

## Resultado observado
Cenário registrado; execução conversacional real pendente.

## Resultado esperado
- A conversa aciona a capacidade descrita em FEATURES.md para EX-03.
...
## Evidência
- Run: `.dogfood/runs/dogfood-full-smoke-20260606-211442/EX-03`
