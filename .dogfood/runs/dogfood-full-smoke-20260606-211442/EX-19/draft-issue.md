# DRAFT Issue — EX-19 — Anti-Slop Visual / Taste (`excrtx-quality-taste`)

## Contexto
Dogfood conversacional local detectou status PARTIAL para a feature EX-19.

## Resultado observado
Cenário registrado; execução conversacional real pendente.

## Resultado esperado
- A conversa aciona a capacidade descrita em FEATURES.md para EX-19.
...
## Evidência
- Run: `.dogfood/runs/dogfood-full-smoke-20260606-211442/EX-19`
