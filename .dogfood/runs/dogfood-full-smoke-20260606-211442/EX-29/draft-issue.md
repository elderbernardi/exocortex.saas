# DRAFT Issue — EX-29 — NotebookLM Ops (`excrtx-integrate-nlmops`)

## Contexto
Dogfood conversacional local detectou status PARTIAL para a feature EX-29.

## Resultado observado
Cenário registrado; execução conversacional real pendente.

## Resultado esperado
- A conversa aciona a capacidade descrita em FEATURES.md para EX-29.
...
## Evidência
- Run: `.dogfood/runs/dogfood-full-smoke-20260606-211442/EX-29`
