# DRAFT Issue — EX-13 — Criar Microverso (`excrtx-memory-newmicro`)

## Contexto
Dogfood conversacional local detectou status PARTIAL para a feature EX-13.

## Resultado observado
Cenário registrado; execução conversacional real pendente.

## Resultado esperado
- A conversa aciona a capacidade descrita em FEATURES.md para EX-13.
...
## Evidência
- Run: `.dogfood/runs/dogfood-full-smoke-20260606-211442/EX-13`
