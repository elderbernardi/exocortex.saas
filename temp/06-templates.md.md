...
dominant_entity:
  type: task|artifact|microverso|decision|activity|inbox|none
  id: null
  inferred: true
...
//TODO verificar forma de tarefa ter estado relacionado a ciclo, pra evitar retrabalho do síndico. Podemos usar o hash da sessão pra identificar mudanças ou retomada de tarefa feita pelo usuário?
Algo como: se tarefa já foi revisada ou em estado de arquivamento e não houve mudança no hash, nada a fazer.
```

## 6.3 `activity.yaml`

```yaml
activity_id: act_slug
